...
png('lcan-x0.2-figure-2-2023-04-28.png', width = 3000, height = 2000)
l = NULL
...
png('lcan-x0.2-figure-3a-2023-04-28.png', width = 3000, height = 2000)
l = NULL
for(filename in filenames) {
    if(is.na(filename)) {
        this_plot = ggplot()
...
png('lcan-x0.2-figure-3b-2023-04-20.png', width = 3000, height = 1000)
l = NULL
for(filename in filenames) {
    this_image = readPNG(filename)
    this_plot = ggplot() + annotation_custom(
