...
full_run('10', '3', '2', '10', '10', '10', '90', 'Shared', 'Intermediate', 'Intermediate', 'Intermediate', '1', '0', '.116', '.627', working_directory = '.', 'facility-added-interface', 'comparable-switched-up', TRUE, analyze_only = 'TRUE', SEVERE_MULTIPLIER = '2', PARALLEL = TRUE)
