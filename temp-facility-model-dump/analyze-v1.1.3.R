...
oneplot('Unavailable-production', shiftwise_unavailable, mean, c(0,0), paste('People Unavailable to Work their Scheduled Shift (out of ', round(production_shift_size,1), ' total)\nProduction', sep = ''), mask = production_shifts)#, main_title = 'Delta')
oneplot('Unavailable-cleaning', shiftwise_unavailable, mean, c(0,0), paste('People Unavailable to Work their Scheduled Shift (out of ', round(cleaning_shift_size,1), ' total)\nCleaning', sep = ''), mask = cleaning_shifts)#, main_title = 'Delta')
