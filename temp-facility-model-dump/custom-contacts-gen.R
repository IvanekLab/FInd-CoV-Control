...
teams = rbind(cbind(team, diff_team),
              cbind(diff_team, team))

shift_floaters_contact_rate = rowSums(teams)[1] / 61

shift_floaters = crew * shift_floaters_contact_rate

shift_floater_tall = matrix(shift_floaters_contact_rate, nrow = 62, ncol = 10)
...
cleaning_shift_contact_rate = rowSums(production_shift)[1] / 19

cleaning_shift = matrix(cleaning_shift_contact_rate, nrow = 20, ncol = 20) - diag(cleaning_shift_contact_rate, nrow = 20)


all_floaters_contact_rate = rowSums(cleaning_shift)[1] / (72 * 2 + 20 + 3 * (10 - 1 + 1) - (10 + 1)) #+1 because of the manager
...
production_shift_1_minus_manager = rbind(cbind(production_shift,
                                               matrix(0, nrow = 72, ncol = 72 + 20),
                                               matrix(all_floaters_contact_rate, nrow = 72, ncol = 10)),
                                         matrix(0, nrow = 72 + 20, ncol = 2 * 72 + 20 + 10),
                                         cbind(matrix(all_floaters_contact_rate, nrow = 10, ncol = 72),
                                               matrix(0, nrow = 10, ncol = 72 + 20),
                                               all_floaters))

manager_row_1 = cbind(matrix(all_floaters_contact_rate, nrow = 1, ncol = 72),
                      matrix(0, nrow = 1, ncol = 72 + 20),
...
production_shift_2_minus_manager = rbind(matrix(0, nrow = 72, ncol = 2 * 72 + 20 + 10),
                                         cbind(matrix(0, nrow = 72, ncol = 72),
                                               production_shift,
                                               matrix(0, nrow = 72, ncol = 20),
                                               matrix(all_floaters_contact_rate, nrow = 72, ncol = 10)),
                                         matrix(0, nrow = 20, ncol = 2 * 72 + 20 + 10),
                                         cbind(matrix(0, nrow = 10, ncol = 72),
                                               matrix(all_floaters_contact_rate, nrow = 10, ncol = 72),
                                               matrix(0, nrow = 10, ncol = 20),
                                               all_floaters))

manager_row_2 = cbind(matrix(0, nrow = 1, ncol = 72),
                      matrix(all_floaters_contact_rate, nrow = 1, ncol = 72),
                      matrix(0, nrow = 1, ncol = 20),
                      matrix(all_floaters_contact_rate, nrow = 1, ncol = 10))
...
manager_row_c = cbind(matrix(0, nrow = 1, ncol = 2 * 72), matrix(all_floaters_contact_rate, nrow = 1, ncol = 20 + 10))
manager_col_c = t(manager_row_c)

cleaning_shift_without_manager = rbind(matrix(0, nrow = 2 * 72, ncol = 2 * 72 + 20 + 10),
                                       cbind(matrix(0, nrow = 20, ncol = 2 * 72),
                                             cleaning_shift,
                                             matrix(all_floaters_contact_rate, nrow = 20, ncol = 10)),
                                       cbind(matrix(0, nrow = 10, ncol = 2 * 72),
                                             matrix(all_floaters_contact_rate, nrow = 10, ncol = 20),
                                             all_floaters))
