...
common_parameters = list(
    ...
    n_mild = '0',
    working_directory = '.',
    folder_name = 'bobrovitz-test--sensitivity-r0s--safer',   # relative to working directory
    analyze_only = FALSE,
    PARALLEL = TRUE,
    #fraction_recovered = 0.69,
    #fraction_fully_vaccinated = 0.71,
...
do.call(full_run, all_params)
all_params = c(common_parameters, additional_facility_parameters, list(unique_id = 'facility-shared-random-start', kConstants = kConstants, crews_per_supervisor = 3, supervisors = 2, n_all_floaters = 11, n_shift_floaters = '10'))
...
all_params = c(
    common_parameters, additional_farm_parameters,
    list(
        unique_id = 'larger-farm-shared-random-start-start-of-epidemic',
        supervisors = '6',
        kConstants = kConstants,
        fraction_recovered = 0, #0.69,
        fraction_fully_vaccinated = 0, #0.71,
...
all_params = c(
    common_parameters, additional_farm_parameters,
    list(
        unique_id = 'larger-farm-shared-random-start',
        supervisors = '6',
        kConstants = kConstants,
        fraction_recovered = 0.69,
        fraction_fully_vaccinated = 0.71,
