...
png('pairwise-scatterplots-with-iii-vs-iii.png', height = 3 * 1000, width = 4 * 1000)
l = 0:5 * 2 + 1
...
for(i in 1:12) {
    ...
    plot(d1iii, x - d1, main = row.names[i], #xlim = c(0, 71), ylim = c(-71, 21),
    ...
    plot(xiii - d1iii, x - d1,# xlim = c(0, 71), ylim = c(-71, 21),
